...
При виконанні цієї роботи побачили, що цей алгоритм є хорошим у випадку, якщо фото є чітким. Фото з тваринами є дуже хорошим випробовуванням для таких програм, оскільки шерсть робить контури менш чіткими та більш складними для виявлення. 
